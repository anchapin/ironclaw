# Agent Task: jailer-integration

## Context
- **Issue:** 18
- **Feature:** jailer-integration
- **Working Directory:** ../ironclaw-jailer-integration
- **Branch:** feature/ISSUE_NUM-jailer-integration

## Your Mission
You are implementing the **jailer-integration** feature for IronClaw Phase 3.
...
```bash
cd ../ironclaw-jailer-integration/orchestrator
...
1. Work in: ../ironclaw-jailer-integration
...
```bash
cd ../ironclaw-jailer-integration
...
# Commit
git add .
git commit -m "feat: implement jailer-integration component
...
git push -u origin feature/ISSUE_NUM-jailer-integration
```
...
```bash
gh pr create \\
  --title "feat: jailer-integration (Issue 18)" \\
  --body "Implements jailer-integration for IronClaw.
